...
namespace KwalityIntegrationScheduler.Classes
{
    public class BL_Registry
    {
        ...
        public static int GetQueryExe(string strSelQry, int CompId, ref string error)
        {
            ...
            {
                error = e.Message;
                FConvert.LogFile("Logs.log", "err : " + "[" + System.DateTime.Now + "] - GetData :" + error + "---" + strSelQry);
                return 0;
            }
        }
        ...
        public static void SetLog(string content)
        {
            ...
            try
            {
                ...
                string sFilePath = folderName + "\\Kwality_EventLog-" + DateTime.Now.ToString("dd-MM-yyyy") + ".txt";
        ...
        public static void SetLog2(string content)
        {
            ...
            try
            {
                ...
                string sFilePath = folderName + "\\Kwality_ErrLog-" + DateTime.Now.ToString("dd-MM-yyyy") + ".txt";
                objSw = new StreamWriter(sFilePath, true);
                objSw.WriteLine(DateTime.Now.ToString() + " " + content + Environment.NewLine);
            }
            catch (Exception ex)
